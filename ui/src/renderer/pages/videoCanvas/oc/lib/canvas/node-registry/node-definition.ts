...
import type { CanvasResourceKind } from "@oc/lib/canvas/canvas-resource-references";
import type { CanvasGenerationMode, CanvasNodeData, CanvasNodeMetadata, CanvasNodeType } from "@oc/types/canvas";
