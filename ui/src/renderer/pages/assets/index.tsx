...
const AssetLibraryPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {dragActive && (
        <div className='pointer-events-none fixed inset-16px z-40 grid place-items-center rounded-16px border-2px border-dashed border-[rgb(var(--primary-6))] bg-[rgba(var(--primary-6),0.08)] backdrop-blur-sm'>
