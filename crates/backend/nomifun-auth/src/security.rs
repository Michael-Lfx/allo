...
/// the office policy below must be `&'static str` for `HeaderValue::from_static`.
...
mod tests {
    ...
    /// Regression: the office preview iframe loads the proxy cross-origin from the
    ...
    #[test]
    #[cfg(debug_assertions)]
    fn a_debug_build_lets_the_vite_dev_origin_frame_office_preview() {
