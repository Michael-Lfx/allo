...
import type { CanvasDrawingEngine } from "@oc/lib/canvas/canvas-drawing-engine";
...
export async function createCanvasDrawingFromImage(
    ...
    const document = engine === "excalidraw"
        ? (await import("@oc/lib/canvas/canvas-drawing-excalidraw-document")).createExcalidrawDrawingFromImage(source)
        : await (await import("@oc/lib/canvas/canvas-drawing-tldraw-document")).createTldrawDrawingFromImage(source);
