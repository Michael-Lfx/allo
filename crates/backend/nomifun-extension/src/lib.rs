...
pub use skill_service::{
    ...
    SkillCatalogItem, SkillListItem, SkillPaths, SkillSource, builtin_skills_corpus, delete_skill,
    ...
    list_builtin_auto_skills, list_catalog_skills, materialize_skills_for_agent, read_builtin_rule,
