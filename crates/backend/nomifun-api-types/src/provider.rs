...
pub struct CreateProviderRequest {
    ...
    /// dropped in migration 023. Kept so older clients sending it are not
...
/// the providers.capabilities column was dropped in migration 023, and the
...
pub struct UpdateProviderRequest {
    ...
    /// Accepted-and-ignored since P3 (column dropped in migration 023).
