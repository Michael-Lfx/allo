...
import { normalizeConnection } from "@oc/lib/canvas/canvas-project-domain";
import type { AiConfig } from "@oc/stores/use-config-store";
import { CanvasNodeType, type CanvasConnection, type CanvasNodeData, type ConnectionHandle, type Position } from "@oc/types/canvas";
