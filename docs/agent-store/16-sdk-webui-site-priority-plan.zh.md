...
> **计数**：✅ 23 项 · 🟡 4 项 · ⏸ 7 项 = **34 项**（R1–R34，无遗漏、无重复；**R20 于 2026-09-11 拆为 R20a / R20b 两个子项，不新增顶层编号，故总数不变**）。**待拍板项：无**——Q2 已于 2026-09-11 按用户决定「站点部署卡点相关问题延后」（连带的 R7 / R32 / R6② 一并延后、不再挂计划）；其余决策（Q1 / Q3–Q7、D1–D12）均已定，见 `21-open-decisions.zh.md`。
>
