import type { DirectorCamera, DirectorObject, DirectorScene, DirectorShot } from "@oc/types/director";
import { directorColorLabel, directorPoseLabel } from "@oc/lib/canvas/director/director-scene";
