import { recordDiagnosticEvent } from "@oc/services/diagnostics/client-diagnostics";

import { formatDirectorDiagnosticCode, projectDirectorDiagnostic, type DirectorDiagnosticCode, type DirectorDiagnosticFields } from "@oc/lib/canvas/director/director-diagnostics";
