...
export const usePasteService = ({
  ...
  // 统一的粘贴事件处理
  // Accept both React's synthetic event and the native ClipboardEvent so the
  // handler matches PasteService.PasteHandler (the global paste listener forwards
  // native events). Both event shapes expose clipboardData/preventDefault/stopPropagation.
