  ...
  return (
    ...
    >
      ...
      <div ref={scrollRef} onScroll={onScroll} className='relative min-h-0 flex-1 overflow-y-auto px-14px py-14px'>
        ...
        {dragActive && (
          <div className='pointer-events-none absolute inset-8px z-10 grid place-items-center rounded-14px border-2px border-dashed border-[rgb(var(--primary-6))] bg-[rgba(var(--primary-6),0.1)] backdrop-blur-sm'>
