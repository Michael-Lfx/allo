...
import { canvasLayoutLane, layoutCanvasAuto, layoutCanvasFlow, layoutCanvasNodesByMediaType } from "@oc/lib/canvas/canvas-layout";
...
describe("canvas media-aware layout", () => {
    ...
    test("节点类型映射为稳定的四类泳道", () => {
        ...
        expect(canvasLayoutLane(node("critique", CanvasNodeType.ArtCritique))).toBe("image");
