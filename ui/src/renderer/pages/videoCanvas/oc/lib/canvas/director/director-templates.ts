...
import { createDirectorActor, createDirectorCamera, createDirectorLight, createDirectorObject, directorFocalLengthToFov, DIRECTOR_ACTOR_COLORS } from "@oc/lib/canvas/director/director-scene-create";
import type { DirectorCamera, DirectorLight, DirectorObject, DirectorScene, DirectorShot } from "@oc/types/director";
