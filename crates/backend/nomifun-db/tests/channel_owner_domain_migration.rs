//! Migration 021 (`channel_plugins.owner_domain`) backfill + guard-trigger
...
async fn seed_pre_021(pool: &sqlx::SqlitePool) {
    // 019 creates cs_* tables; 020 is channel pending. owner_domain arrives at 021.
