 ...
 * (`Flowy.exe mcp-*-stdio`). If the dev app dies without cleanup
 ...
 * Usage: bun scripts/kill-stale-dev.mjs [binary-name ...]   (default: Flowy)
 */
...
if (names.length === 0) names.push("Flowy");
