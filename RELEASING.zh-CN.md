...
- 手动安装包：`dist/desktop/Flowy_<version>_universal.dmg`
- 自动更新包：`target/universal-apple-darwin/release/bundle/macos/Flowy.app.tar.gz`
- 自动更新签名：`target/universal-apple-darwin/release/bundle/macos/Flowy.app.tar.gz.sig`
...
- 已上传 `Flowy_0.1.11_universal.dmg`。
- 已上传 `Flowy.app.tar.gz` 和 `Flowy.app.tar.gz.sig`。
