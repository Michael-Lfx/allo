...
describe('support surface browser probe contract', () => {
  test('renders the production modal view and both controlled surface fixtures', () => {
    ...
    expect(probe).toContain('modalHeightExplicit');
    expect(probe).toContain('modalHeightDelta');
    expect(probe).toContain('verticalCenterDelta');
    expect(probe).toContain('inputToolbarOverlap');
    ...
    expect(probe).toContain('support-modal-height-shift');
    expect(probe).toContain('support-modal-not-vertically-centered');
    expect(probe).toContain('feedback-footer-not-visible');
    expect(probe).toContain('textarea-toolbar-overlap');
