...
const ENTITY_PRIMARY_KEYS: &[(&str, &str)] = &[
    ...
    ("learning_concepts", "id"),
    ("learning_courses", "id"),
    ("learning_enrollments", "id"),
    ("learning_lessons", "id"),
    ("learning_modules", "id"),
    ("learning_review_items", "id"),
    ("mcp_servers", "id"),
    ("messages", "id"),
    ("presets", "id"),
    ("preset_tags", "key"),
...
const ENTITY_REFERENCE_COLUMNS: &[(&str, &str)] = &[
    ...
    ("learning_activities", "lesson_id"),
    ("learning_activity_concepts", "activity_id"),
    ("learning_activity_concepts", "concept_id"),
    ("learning_attempts", "enrollment_id"),
    ("learning_attempts", "activity_id"),
    ("learning_concepts", "course_id"),
    ("learning_concept_prerequisites", "concept_id"),
    ("learning_concept_prerequisites", "prerequisite_concept_id"),
    ("learning_courses", "source_kb_id"),
    ("learning_enrollments", "user_id"),
    ("learning_enrollments", "course_id"),
    ("learning_lessons", "module_id"),
    ("learning_lesson_concepts", "lesson_id"),
    ("learning_lesson_concepts", "concept_id"),
    ("learning_lesson_progress", "enrollment_id"),
    ("learning_lesson_progress", "lesson_id"),
    ("learning_mastery_states", "enrollment_id"),
    ("learning_mastery_states", "concept_id"),
    ("learning_modules", "course_id"),
    ("learning_review_items", "enrollment_id"),
    ("learning_review_items", "concept_id"),
