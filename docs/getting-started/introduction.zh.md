...
**Flowy** 是一个面向 AI agent 工作流的本地优先工作台。它把多种
...
Flowy 更适合已经在用 agent 做真实工作的用户。它要求你理解 API key、
...
Flowy 仍在活跃开发中，但已经不是旧的 Electron 多仓迁移状态。当前仓库是
