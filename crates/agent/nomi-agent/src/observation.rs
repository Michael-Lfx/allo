...
use nomi_agent_trace::{
    ObservationEvent, ObservationIds, ObservationRecorder, ObservationScope, RecorderError,
...
impl ObservationSession {
    ...
    pub fn bind_ids(&self, mut ids: ObservationIds) {
            ...
            match &event {
                ...
                LlmEvent::Done { stop_reason, usage } => {
                    ...
                    emit_response(
                        ...
                        &thinking,
                        &tool_use,
                        Some(stop_reason_name(*stop_reason)),
