 ...
 *   bun scripts/check-dead-css-utilities.mjs --dump-baseline # 打印当前树的 BASELINE Map 字面量
 */
...
/**
 * 存量基线 / Pre-existing baseline（由当前树扫描生成，只允许变短）。
...
const BASELINE = new Map([
  ...
  ['ui/src/renderer/components/settings/UpdateModal.tsx', { ramp: 16 }],
  ['ui/src/renderer/components/workspace/WorkspaceFolderSelect.tsx', { deadBorder: 2 }],
  ['ui/src/renderer/features/supportChat/components/SupportChatModal.tsx', { borderNoStyle: 1 }],
  ...
  ['ui/src/renderer/pages/conversation/Messages/components/PinnedPlan.tsx', { ramp: 1 }],
  ...
  ['ui/src/renderer/pages/conversation/Preview/components/viewers/HTMLViewer.tsx', { deadBorder: 1 }],
  ...
  ['ui/src/renderer/pages/conversation/SessionList/WorkpathDrawer.tsx', { ramp: 2 }],
  ['ui/src/renderer/pages/conversation/Workspace/components/FileChangeList.tsx', { borderNoStyle: 3, dirNamedBorder: 3 }],
  ['ui/src/renderer/pages/conversation/Workspace/components/WorkspaceToolbar.tsx', { borderNoStyle: 1, dirNamedBorder: 1 }],
  ['ui/src/renderer/pages/cron/ScheduledTasksPage/index.tsx', { deadBorder: 1, ramp: 1 }],
  ...
  ['ui/src/renderer/pages/knowledge/KnowledgeDetailPage/index.tsx', { ramp: 5 }],
  ['ui/src/renderer/pages/knowledge/KnowledgeEmptyState.tsx', { ramp: 1 }],
  ...
  ['ui/src/renderer/pages/nomi/FigureCardActions.tsx', { ramp: 4 }],
  ['ui/src/renderer/pages/openCapabilities/index.tsx', { deadBorder: 2 }],
  ['ui/src/renderer/pages/requirements/components/RequirementDisplayNumber.tsx', { ramp: 2 }],
  ['ui/src/renderer/pages/requirements/RequirementDrawer/AttachmentsField.tsx', { deadBorder: 2 }],
  ...
  ['ui/src/renderer/pages/requirements/WorkspacePage/RequirementFilters.tsx', { ramp: 2 }],
  ...
  ['ui/src/renderer/pages/settings/CloudLoginSettings.tsx', { borderNoStyle: 1 }],
  ...
  ['ui/src/renderer/pages/settings/MarketSettingsPanel.tsx', { ramp: 1 }],
  ['ui/src/renderer/pages/settings/PresetSettings/PresetEditDrawer.tsx', { borderNoStyle: 5, deadBorder: 1, dirNumBorder: 2, doublePrefix: 7, ramp: 1 }],
  ['ui/src/renderer/pages/settings/PresetSettings/PresetListPanel.tsx', { deadBorder: 1 }],
  ...
  ['ui/src/renderer/pages/settings/skill/AgentSkillImportDrawer.tsx', { deadBorder: 1, generator: 1 }],
  ['ui/src/renderer/pages/settings/skill/MarketToolbar.tsx', { deadBorder: 1 }],
  ['ui/src/renderer/pages/settings/skill/SkillCard.tsx', { ramp: 4 }],
  ['ui/src/renderer/pages/settings/skill/SkillDetailDrawer.tsx', { ramp: 3 }],
  ['ui/src/renderer/pages/settings/SkillsHubSettings.tsx', { borderNoStyle: 1, dirNamedBorder: 1 }],
  ['ui/src/renderer/pages/videoCanvas/oc/components/canvas/asset-picker-modal.tsx', { borderNoStyle: 1 }],
  ['ui/src/renderer/pages/videoCanvas/oc/components/canvas/canvas-agent-chat-ui.tsx', { borderNoStyle: 1 }],
  ['ui/src/renderer/pages/videoCanvas/oc/components/canvas/canvas-assistant-panel-views.tsx', { generator: 1 }],
  ['ui/src/renderer/pages/videoCanvas/oc/components/canvas/canvas-character-reference-modal.tsx', { generator: 13 }],
  ['ui/src/renderer/pages/videoCanvas/oc/components/canvas/canvas-character-reference-node.tsx', { generator: 4 }],
  ['ui/src/renderer/pages/videoCanvas/oc/components/canvas/canvas-context-menu.tsx', { borderNoStyle: 1 }],
  ...
  ['ui/src/renderer/pages/videoCanvas/oc/components/canvas/canvas-project-card.tsx', { borderNoStyle: 3, generator: 5 }],
  ['ui/src/renderer/pages/videoCanvas/oc/components/canvas/canvas-project-sidebar.tsx', { borderNoStyle: 2, generator: 24 }],
  ['ui/src/renderer/pages/videoCanvas/oc/components/canvas/canvas-script-node.tsx', { generator: 3 }],
  ['ui/src/renderer/pages/videoCanvas/oc/components/canvas/canvas-text-editor-modal.tsx', { dirNumBorder: 2, generator: 1 }],
  ['ui/src/renderer/pages/videoCanvas/oc/components/canvas/canvas-workspace-overlays.tsx', { borderNoStyle: 1 }],
  ['ui/src/renderer/pages/videoCanvas/oc/components/canvas/director/canvas-director-node-panel.tsx', { borderNoStyle: 2 }],
  ['ui/src/renderer/pages/videoCanvas/oc/components/layout/workspace-page.tsx', { generator: 7 }],
  ['ui/src/renderer/pages/videoCanvas/oc/components/layout/workspace-state.tsx', { generator: 4 }],
  ['ui/src/renderer/pages/videoCanvas/oc/components/model-picker.tsx', { generator: 1 }],
  ['ui/src/renderer/pages/videoCanvas/oc/components/ui/aceternity/announcement-timeline-modal.tsx', { generator: 14 }],
  ['ui/src/renderer/pages/videoCanvas/oc/components/ui/aceternity/full-screen-loader.tsx', { borderNoStyle: 2 }],
  ['ui/src/renderer/pages/videoCanvas/oc/components/ui/aceternity/workspace-signal-icon.tsx', { generator: 2 }],
  ['ui/src/renderer/pages/videoCanvas/oc/pages/canvas/canvas-refresh-shell.tsx', { borderNoStyle: 1, generator: 3 }],
  ['ui/src/renderer/pages/videoCanvas/oc/pages/canvas/index.tsx', { generator: 5 }],
  ['ui/src/renderer/pages/videoCanvas/oc/pages/canvas/project.tsx', { generator: 1 }],
  ['ui/src/renderer/pages/videoGeneration/components/AspectRatioPicker.tsx', { ramp: 4 }],
  ['ui/src/renderer/pages/videoGeneration/components/ProgressTimeline.tsx', { ramp: 6 }],
  ['ui/src/renderer/pages/videoGeneration/components/SessionCard.tsx', { ramp: 2 }],
  ['ui/src/renderer/pages/videoGeneration/components/StoryboardBoard.tsx', { borderNoStyle: 1 }],
  ['ui/src/renderer/pages/videoGeneration/components/TvShowCard.tsx', { ramp: 4 }],
  ['ui/src/renderer/pages/videoGeneration/components/TvShowPanel.tsx', { ramp: 3 }],
  ['ui/src/renderer/pages/videoGeneration/components/VideoGenerationHoverCard.tsx', { ramp: 1 }],
  ['ui/src/renderer/pages/videoGeneration/components/VideoQualityPickers.tsx', { ramp: 8 }],
  ['ui/src/renderer/pages/videoGeneration/components/WorkspaceActionAssets.tsx', { ramp: 1 }],
  ['ui/src/renderer/pages/videoGeneration/index.tsx', { ramp: 1 }],
  ['ui/src/renderer/pages/videoGeneration/WorkspacePage.tsx', { ramp: 2 }],
  ['ui/src/renderer/pages/workshop/assets/AssetCard.tsx', { ramp: 5 }],
  ...
  ['ui/src/renderer/pages/workshop/canvas/nodes/CompareNode.tsx', { ramp: 2 }],
  ['ui/src/renderer/pages/workshop/canvas/nodes/GroupNode.tsx', { ramp: 1 }],
  ['ui/src/renderer/pages/workshop/canvas/nodes/ImageNode.tsx', { ramp: 2 }],
  ...
  ['ui/src/renderer/pages/workshop/canvas/nodes/OutputNode.tsx', { ramp: 2 }],
  ...
  ['ui/src/renderer/pages/workshop/CanvasPage.tsx', { ramp: 4 }],
...
function verdictFor(file, counts, baseline = BASELINE) {
  ...
  const forms = new Set([...Object.keys(FORMS), ...Object.keys(base), ...Object.keys(counts)]);
  const worse = [];
  const better = [];
...
function selfTest() {
  ...
  const verdicts = [
    ...
    { file: 'ui/src/fake/Baselined.tsx', counts: { ramp: 2, dirNamedBorder: 1 }, want: 'regression' },
  ];
...
const dumpBaseline = process.argv.includes('--dump-baseline');
...
for (const abs of walk(SCAN_DIR)) {
  ...
  for (const { line, text } of extractClassLists(source)) {
    for (const t of tokenize(text)) {
      if (!looksLikeUtility(t)) continue;
      if (!utilityOcc.has(t)) utilityOcc.set(t, []);
      utilityOcc.get(t).push({ file, line });
    }
  }
}

const tokens = [...utilityOcc.keys()];
const t0 = Date.now();
const { matched } = await uno.generate(tokens.join(' '), { preflights: false });
const elapsedMs = Date.now() - t0;
const deadTokens = new Set(tokens.filter((t) => !matched.has(t)));

for (const [token, occs] of utilityOcc) {
  if (!deadTokens.has(token)) continue;
  for (const { file, line } of occs) {
...
for (const [file, { hits }] of perFile) {
  ...
  if (hits.length || BASELINE.has(file)) found.set(file, { hits, counts });
}
...
if (dumpBaseline) {
  ...
  const occ = [...found.values()].reduce((a, { hits }) => a + hits.length, 0);
  console.error('# baseline: ' + total + ' file(s) / ' + occ + ' occurrence(s); generator compile ' + elapsedMs + 'ms');
  process.exit(0);
}
...
console.log(
  '✅ dead CSS utilities clean (' + scanned + ' file(s) scanned; baseline holds ' + BASELINE.size + ' file(s) / ' + baselineTotal + ' occurrence(s); ' +
    tokens.length + ' utility-shaped token(s) through generator in ' + elapsedMs + 'ms, no new or worsened use)',
);
