...
Section "$(webview2SectionTitle)"
 ...
 DetailPrint "$(webview2InstallEstimate)"
 DetailPrint "$(webview2InstallPleaseWait)"
 ...
 install_webview2:
 ; Keep the Microsoft bootstrapper silent (no separate Edge UI) and surface
 ; estimate / wait copy in Flowy's own InstFiles details pane instead.
 SetDetailsView show
